...
1. Run the learned asset update script first. In Codex use:
   ...
   In Codex use the same script under `.Codex/skills/wechat-svg-authoring/scripts/`.
...
8. Sync updated notes into this skill's `references/` folder and the matching Codex/Codex skill folder when present.
